...
const {existsSync, mkdirSync, readdirSync, readFileSync, rmdirSync, symlinkSync, unlinkSync, writeFileSync} = require('fs')
const glob = require('glob')
const {inline, logOK, throwErr, warn} = require('./console')
const {DEVERR, PKG, WORKSPACE} = require('../constants')
